...
public class LeaderBoardController implements Initializable{
	...
	@Override
	public void initialize(URL arglocation, ResourceBundle resources) {
		username.setCellValueFactory(new PropertyValueFactory<>("Username"));
		highscore.setCellValueFactory(new PropertyValueFactory<>("HighScore"));
		
		PriorityQueue<UserProfile> aux = LoginController.getLeaderBoard().getBoard();
		while(!aux.isEmpty()) {
			observableList.add(aux.remove());
		}
